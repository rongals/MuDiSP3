...
set key title ""
set key left bottom Right noreverse box linetype -2 linewidth 1.000 samplen 4 spacing 1 width 0
set nolabel
set noarrow
set nolinestyle
set nologscale
...
set nox2tics
set noy2tics
set title "CDMA Blind vs MF Performance, 2 users, AWGN, interference 10 dB louder" \
	0.000000,0.000000  ""
...
set xlabel "E_b/N_0 (dB)" 0.000000,0.000000  ""
...
set ylabel "P_e" 0.000000,0.000000  ""
...
set tmargin -1
set locale "C"
plot 	'results/cdma_awgn_63c2u_blind.dat' ti "Blind MUD" w linesp, \
 	'results/cdma_awgn_63c2u_mf.dat' ti "MF" w linesp
#    EOF
